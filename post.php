<?php
  $post = [
    ...
    'text' => 'Dark spruce forest frowned on either side the frozen waterway. The trees had been
    ...
    laughter more terrible than any sadnessa laughter that was mirthless as the smile of
    ...
    the effort of life. It was the Wild, the savage, frozen-hearted Northland Wild.<br><br>
    ...
    that all movement must in the end come to the cessation of movement.<br><br>
...
<head>
  ...
  <title><?=$post[$_GET['id'] - 1]['title'] ?></title>
</head>
<body>
  <header class="header">
    <div class="header__inner">
      <div class="header__panel panel">
        <a class="header__escape escape" href="home.php">Escape.</a>
        <nav class="header__menu">
          <ul class="header__menu-list">
            <li class="header__menu-item"><a class="header__menu-link link" href="home.php">HOME</a></li>
            <li class="header__menu-item"><a class="header__menu-link link" href="#">CATEGORIES</a></li>    
            <li class="header__menu-item"><a class="header__menu-link link" href="#">ABOUT</a></li>    
            <li class="header__menu-item"><a class="header__menu-link link" href="#">CONTACT</a></li>          
          </ul>  
        </nav>
      </div>
  </header>
  <main class="main">
    <div class="text">
      <h1 class="title"><?=$post[$_GET['id'] - 1]['title'] ?><?=$_GET['id'] ?></h1>
      <p class="subtitle"><?=$post[$_GET['id'] - 1]['subtitle'] ?></p>
    </div>
    <div class="Polar Lights"></div>
    <div class="text">
      <p class="main text">
        <?= $post[$_GET['id'] - 1]['text']?>   
      </p>
  ...
  <footer class="footer">
    <div class="footer-container">
      <a class="Escape-footer" href="home.php">Escape.</a>
      <ul class="nav">
